            ...
            client.get(ARTICLE_SEARCH_URL, object : JsonHttpResponseHandler() {
                ...
                override fun onSuccess(statusCode: Int, headers: Headers, json: JSON) {
                    ...
                    try {
                        ...
                        // Let go over this before the end of class
                        parsedJson.response?.docs?.let { list ->
                            lifecycleScope.launch(IO) { /* <--- This uses IO because it useful for room operations but we could use this also for network requests like the client function above. */
